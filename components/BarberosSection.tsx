        ...
        {BARBERS.map((b, i) => (
          <div key={b.id} data-barber-card>
            <div className="relative aspect-[3/4] overflow-hidden rounded-card">
              ...
              <span className="absolute left-3 top-3 rounded-ctl bg-ink/55 px-[9px] py-[5px] font-mono text-xs uppercase tracking-[0.18em] text-bronze backdrop-blur-sm">
                0{i + 1}
              </span>
            </div>
            <div className="mt-5 flex items-baseline justify-between gap-2.5">
              ...
              <span className="whitespace-nowrap font-mono text-xs uppercase tracking-[0.14em] text-bronze">
                {b.role}
              </span>
            </div>
