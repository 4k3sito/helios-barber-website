    ...
    <footer id="contacto" className="mt-[clamp(40px,6vw,80px)] border-t border-white/8 bg-ink-2 px-[clamp(20px,5vw,72px)] pt-[clamp(72px,11vw,150px)]">
      <div className="mx-auto max-w-content">
        <div className="grid items-end gap-[clamp(34px,6vw,80px)] lg:grid-cols-[1.4fr_1fr]" data-grid>
          <div>
            <div className="mb-[26px] flex items-center gap-3.5 font-mono text-xs uppercase tracking-[0.2em] text-accent section-kicker">
              <span>(05)</span>
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              className="mt-[38px] inline-flex items-center gap-3 rounded-ctl bg-accent px-[26px] py-4 font-mono text-xs uppercase tracking-[0.14em] text-ink transition-opacity hover:opacity-82"
            >
        ...
        <div className="mt-[clamp(56px,8vw,110px)] flex flex-wrap items-center justify-between gap-6 border-t border-white/8 px-0 py-[30px]">
          <div className="flex items-center gap-3.5">
            <Image src="/assets/sun-light.png" alt="Helios" width={40} height={40} className="size-10" />
            <div>
        ...
        <div className="flex flex-wrap gap-5 border-t border-white/8 py-6 font-mono text-xs uppercase tracking-[0.12em] text-tertiary">
          <Link href="/privacidad" className="transition-colors hover:text-accent">Aviso de privacidad</Link>
          <Link href="/terminos" className="transition-colors hover:text-accent">Términos de servicio</Link>
        </div>
      </div>
    </footer>
  );
